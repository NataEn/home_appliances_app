...
export interface SettingOptionProps {
    ...
    value: string,
    className: string,
    onClickOption:(optionClassName:string, value:string)=>void
}
...
const SettingOption: FC<SettingOptionProps> = ({ uuid, value, className, selectedOption, onClickOption }): JSX.Element => {
    return <div className={Utils.AddClassNames(["option", "btn", className])} key={uuid} onClick={(e: React.MouseEvent)=>onClickOption(className, value)}>
